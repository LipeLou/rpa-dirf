...
CNPJ_EMPRESA = "19.310.796/0001-07"

# CNPJ padrão da operadora de saúde (usado quando não especificado)
CNPJ_OPERADORA_PADRAO = "23.802.218/0001-65"
...
VERIFICACAO_MANUAL_PADRAO = False
